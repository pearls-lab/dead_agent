...
SelfDQN = TypeVar("SelfDQN", bound="SAFE_DQN")

class SAFE_DQN(OffPolicyAlgorithm):
    """
    Deep Q-Network (DQN)
    ...
    def __init__(
        ...
        self.buffer_logs = []
        self.all_losses  = []
        if 'multi_buffer' in args.keys():
            self.multi_buffer = args['multi_buffer']
        else:
            self.multi_buffer = False
